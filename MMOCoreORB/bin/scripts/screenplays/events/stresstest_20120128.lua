...
function stresstest_20120128:barkShuttleLocation(pBarker)
	if (pBarker ~= nil) then
		spatialChat(pBarker, "\\#881100Greetings Testers!\n\nPlease proceed to the shuttles near South Coronet (-154 -4767). Double click the terminals at these locations to arrive at the focus destination. Character Builder Terminals will be available at your destination. Don't Forget about Support City Swggr located on Corellia. where if you need help, you can get it!\n\nThanks for testing!")
