...
function geonosian_labscreenplay:spawnMobiles()
	...
	spawnMobileRandom("yavin4", "acklay", 120,101.1,-34.3,-321.6,-136,1627823)
        spawnMobileRandom("yavin4", "enhanced_gaping_spider", 120,-130,-22.1,-85,-180,1627794)
        ...
        spawnMobile("yavin4", "crazed_geonosian_guard",10,1.2,9.1,-8.1,63,1627781)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,0.6,9.5,-3.5,99,1627781)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,26.6,10.3,-13.3,-8,1627782)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,32.3,9.5,-8.1,-105,1627782)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,34.7,10.3,-14.4,-70,1627782)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,37.4,9.8,-8.2,-109,1627782)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-55.9,-18,-33.9,95,1627785)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-55.6,-18,-43.2,72,1627785)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-38.7,-18,-47.5,-75,1627785)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-66.7,-19,-41.2,-77,1627788)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-70.5,-18.9,-34.5,-161,1627788)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-83.9,-18.5,-42.3,85,1627788)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-36,-22,-151.4,180,1627803)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-26.8,-22.9,-158,-90,1627803)
        spawnMobile("yavin4", "crazed_geonosian_guard",10,-19.4,-22.6,-151.7,-135,1627803)
	...
	spawnMobile("yavin4", "acklay",120,-129.0,-34,-192.6,-32,1627815)   
	...
	spawnMobile("yavin4", "alert_droideka",600,-129.8,-34.0,-267.9,87,1627816)
        spawnMobile("yavin4", "enhanced_gaping_spider",120,26,-31.5,-78,170,1627798)   
	spawnMobile("yavin4", "acklay",120,-64.9,-34,-266.5,-143,1627812)          
